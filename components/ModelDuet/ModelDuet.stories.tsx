...
/** Portrait, because the stage is 0.82:1 — `mockImage` ranks the pool by how close the shape is. */
const FALLBACK = mockImage({ altText: ALT, height: 780, seed: 'model-duet', width: 640 });
 ...
 * stage that quietly went taller than `DUET_MIN_ASPECT` (0.752:1) would crop a hand at the one moment the two loops
